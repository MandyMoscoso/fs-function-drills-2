...
// CODE HERE
const totalPopulation = populations.reduce((totalPopulation, curPopulation) => totalPopulation + curPopulation);
...
// CODE HERE
const myStrongest  = monstersInYourPocket.filter((num) => num.CP >200);
...
const orderTotal  = orders.map(num => num.price = num.price *(1+num.tax));
...
// CODE HERE
const totalBobPurchases = purchases.filter(name  => name. owner ==="Bob" ).reduce((arr, cur) => arr + cur.price,0);

console.log(totalBobPurchases)
