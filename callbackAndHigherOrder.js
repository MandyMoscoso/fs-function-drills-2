...
// CODE HERE
const printUniqNames = (uniqArr)=>{
  console.log(`The new names array with all the duplicate items removed is ${uniqArr}.`)
};
uniq(names,printUniqNames);
...
// CODE HERE
const checkItemIndex = (item, index) =>{
  console.log(`The item at index ${index} is ${item}.`);
};
each(names,checkItemIndex);
...
// CODE HERE
const addFourTwenty = addingFactory(420);
console.log(addFourTwenty(69000));